...
namespace DirectWriteTypeLayout
{
    ...
    public:
                                     ...
                                     IUnknown* clientDrawingEffect)
        {
            ...
            glyphRunLayout->font = Font (glyphRun->fontEmSize / fontHeightToEmSizeFactor, fontFamily, fontStyle);
                             ...
                             const int textLen, ID2D1DCRenderTarget* const renderTarget, IDWriteFontCollection* const fontCollection)
    {
        ...
        if (attr.getFont() != nullptr)
        {
            ...
            uint32 fontIndex;
            fontCollection->FindFamilyName (attr.getFont()->getTypefaceFamily().toWideCharPointer(), &fontIndex, &fontFound);
            ...
            // Set the font family
            textLayout->SetFontFamilyName (attr.getFont()->getTypefaceFamily().toWideCharPointer(), range);
            // Set the font style
                       ...
                       ID2D1Factory* const direct2dFactory, IDWriteFontCollection* const fontCollection)
    {
        ...
        BOOL fontFound = false;
        uint32 fontIndex;
        fontCollection->FindFamilyName (defaultFont.getTypefaceFamily().toWideCharPointer(), &fontIndex, &fontFound);
        ...
        hr = directWriteFactory->CreateTextFormat (defaultFont.getTypefaceFamily().toWideCharPointer(), fontCollection,
